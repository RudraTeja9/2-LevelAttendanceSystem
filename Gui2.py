...
def rollNo():
    ...
    if validity:
    	frame1.place_forget()
    	frame3.place_forget()
    	frame2.place(relx=0, rely=0.3, relwidth=1.0, relheight=0.35)
        ...
        label1.place(relx=0.25, rely=0.33, relheight=0.33, relwidth=0.5)
...
def authentication():
    ...
    frame3.place(relx=0, rely=0.3, relwidth=1.0, relheight=0.35)
...
def try_again():
    frame2.place_forget()
    frame3.place_forget()
    frame1.place(relx=0, rely=0.3, relwidth=1.0, relheight=0.35)
    heading_label['text']='First level Authentication'
...
# FRAME CODE
frame1 = tk.Frame(root, bg='khaki', bd=5)
frame1.place(relx=0, rely=0.3, relwidth=1.0, relheight=0.35)

frame2 = tk.Frame(root, bg='khaki', bd=5)


# BUTTON FRAME (PRESS TO PLACE ID)
button = tk.Button(frame1, text='press to place id card', command=rollNo, font=fontStyle,
...
button1 = tk.Button(frame2, text='press to place your face', command=authentication, font=fontStyle)
button1.place(relx=0.33, rely=0.33, relheight=0.33, relwidth=0.33)

frame3 = tk.Frame(root, bg='khaki', bd=5)

label = tk.Label(frame3, text="", font=('courier', 20))
button2=tk.Button(frame3,text='Go back',command=try_again,font=fontStyle,activebackground="khaki")

label.place(relx=0.2, rely=0.33, relheight=0.33, relwidth=0.6)
button2.place(relx=0.33,rely=0.75,relheight=0.25,relwidth=0.33)
